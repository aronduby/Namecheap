...
class Client
{
	...
	/**
	 * @var ParserOptions the options for the response parser
	 */
	 ...
	 *
	 */
	public function __construct($api_user, $api_key, $client_ip, $sandbox = false, ParserOptions $parser_options)
	{
	...
	public function send($command, $params = array())
	{
		...
		return new Response($response, $this->request, $this->parser_options);
	}
